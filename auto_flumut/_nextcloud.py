...
def load_credentials():
    AUTH_USER = os.getenv('NEXTCLOUD_API_USERNAME')
    AUTH_PASSWORD = os.getenv('NEXTCLOUD_API_PASSWORD')
...
def nc_upload_file(local_file_path, remote_file_path):
    ...
    remote_file_path = re.sub(f'^.+/files/', '', remote_file_path)
...
def nc_make_folder(remote_folder_path):
    ...
    remote_folder_path = re.sub(f'^.+/files/', '', remote_folder_path)
